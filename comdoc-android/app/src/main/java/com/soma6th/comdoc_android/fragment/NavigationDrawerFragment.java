...
import com.soma6th.comdoc_android.activity.ChangePasswordActivity;
import com.soma6th.comdoc_android.activity.SheetInfoActivity;
import com.soma6th.comdoc_android.activity.ProfileUpdateActivity;
import com.soma6th.comdoc_android.activity.SheetRequestActivity;
import com.soma6th.comdoc_android.activity.SignInActivity;
import com.soma6th.comdoc_android.activity.SignUpActivity;
import com.soma6th.comdoc_android.adapter.NavigationAdapter;

import static com.soma6th.comdoc_android.util.Constants.URL_FACEBOOK;
import static com.soma6th.comdoc_android.util.Constants.URL_GOOGLE_PLUS;
import static com.soma6th.comdoc_android.util.Constants.URL_LINKEDIN;
import static com.soma6th.comdoc_android.util.Constants.URL_TWITTER;
import static com.soma6th.comdoc_android.util.Constants.URL_YOUTUBE;
...
import static com.soma6th.comdoc_android.util.UtilMethods.showExitDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView.findViewById(R.id.btnSheetRequest).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                closeDrawer();
                getActivity().
                startActivity(new Intent(getActivity(), SheetRequestActivity.class));
        ...
        rootView.findViewById(R.id.btnSheetInfo).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), SheetInfoActivity.class));
                closeDrawer();
            }
        });
